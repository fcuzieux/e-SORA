...
import { OperatorForm } from './forms/OperatorFormold';
import { DroneForm } from './forms/DroneForm';
import { OperationForm } from './forms/OperationFormold';
              ...
              onChange={(drone) => { 
                setFormData({
                  ...
                  riskAssessment: {
                    ...
                    MTOW: drone.MTOW,
                    maxGustSpeed : drone.environmentalLimitations.maxGustSpeed,
